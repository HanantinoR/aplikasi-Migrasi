                    ...
                    <div class="card shadow-xs mb-4">
                        <div class="card-header border-bottom pb-0">
                            <div class="d-sm-flex align-items-center mb-3">
                                <div>
                                    <h6 class="font-weight-semibold text-lg mb-0">TAHAP 4</h6>
                                    <p class="text-sm mb-sm-0"><strong>Rekonsiliasi Titik Koordinat Pekebun</strong></p>
                                </div>
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ( $get_data_kelembagaan_pekebun as $proposal )
                                            <tr>
                                                ...
                                                <th class="text-secondary text-xs font-weight-semibold opacity-7">
                                                    <a href='{{route('tahap4.detail',["id_proposal"=>$proposal->id])}}' type="button" class="btn btn-sm btn-info m-0 ">Rekonsiliasi Titik Koordinat Pekebun!</a>
