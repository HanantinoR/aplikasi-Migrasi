<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 bg-slate-900 fixed-start " id="sidenav-main">
    <div class="sidenav-header">
        ...
        <a class="navbar-brand d-flex align-items-center m-0"
            href="#">
            <span class="font-weight-bold text-lg">Rekon Data PSR</span>
        </a>
    </div>
    <div class="collapse navbar-collapse px-4  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <span class="font-weight-normal text-md ms-2">Rekonsiliasi Data PSR</span>
                </div>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('tahap.1') ? 'active' : '' }}"
                    href="{{ route('tahap.1') }}">
                    <span class="nav-link-text ms-1">Tahap 1 - Data Awal</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('tahap.2') ? 'active' : '' }}"
                    href="{{ route('tahap.2') }}">
                    <span class="nav-link-text ms-1">Tahap 2 - Dok Pekebun</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('tahap.3') ? 'active' : '' }}"
                    href="{{ route('tahap.3') }}">
                    <span class="nav-link-text ms-1">Tahap 3 - Dok Proposal + LP</span>
                </a>
            </li>
            <li class="nav-item border-start my-0 pt-2">
                <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('tahap.4') ? 'active' : '' }}"
                    href="{{ route('tahap.4') }}">
                    <span class="nav-link-text ms-1">Tahap 4 - Titik Koordinat</span>
                </a>
            </li>
            @if (Auth::user()->roles == "Direktorat Jenderal Perkebunan")
                <li class="nav-item mt-2">
                    <div class="d-flex align-items-center nav-link">
                ...
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link position-relative ms-0 ps-2 py-2 {{ is_current_route('manajemen_akun.index') ? 'active' : '' }}"
                        href="{{ route('manajemen_akun.index') }}">
                ...
                <li class="nav-item border-start my-0 pt-2">
                    <a class="nav-link position-relative ms-0 ps-2 py-2 "
                        href="">
                        <span class="nav-link-text ms-1">Log Manajemen Akun</span>
                    </a>
                </li>
            @endif
        </ul>
