                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-4">
                                        <div class="h-100">
                                            ...
                                            <input type="text" id="nama_pengguna" name="nama_pengguna" class="form form-control" placeholder="Masukkan Nama Pengguna Baru" required value="{{@$users->name}}">
                                    ...
                                    <div class="col-lg-12 mb-4">
                                        <div class="h-100">
                                            ...
                                            <input type="email" id="email_pengguna" name="email_pengguna" class="form form-control" placeholder="Masukkan E-mail Pengguna Baru" required value="{{@$users->email}}">
            ...
            Swal.fire({
                ...
                preConfirm: () => {
                    return new Promise((resolve, reject) => {
                            ...
                            $.ajax({
                                url: "{{ route('manajemen_akun.post_edit_akun',['id_pengguna'=>$users->id]) }}",
                                processData: false,
                                contentType: false,
                                type: 'POST',
                                headers: {
